...
if ( ! function_exists( 'mv_shortcodes_pro_sort_shortcodes' ) ) {
	...
	*/
	...
	<div class="wrap"> 
		...
		<h3 id="h3-row1"><span><?php _e( 'Row 1', 'shortcodes-pro' ); ?></span> <img src="<?php bloginfo( 'url' ); ?>/wp-admin/images/loading.gif" id="loading-row1" class="loading" /></h3>
		...
		<h3 id="h3-row2"><span><?php _e( 'Row 2', 'shortcodes-pro' ); ?></span> <img src="<?php bloginfo( 'url' ); ?>/wp-admin/images/loading.gif" id="loading-row2" class="loading" /></h3>
		...
		<h3 id="h3-row3"><span><?php _e( 'Row 3', 'shortcodes-pro' ); ?></span> <img src="<?php bloginfo( 'url' ); ?>/wp-admin/images/loading.gif" id="loading-row3" class="loading" /></h3>
		...
		<h3 id="h3-row4"><span><?php _e( 'Row 4', 'shortcodes-pro' ); ?></span> <img src="<?php bloginfo( 'url' ); ?>/wp-admin/images/loading.gif" id="loading-row4" class="loading" /></h3>
