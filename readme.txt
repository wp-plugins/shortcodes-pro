...
* Create custom shortcodes from inside WordPress.
...
* Uses WordPress built-in transients for fast performance.
...
= 1.1.4 =
* manage_options set as default capability for creating shortcodes
